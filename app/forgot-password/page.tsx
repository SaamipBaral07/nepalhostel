  ...
  return (
    <>
      ...
      <div className="fp-page">
        <div className="fp-bg" />
        <div className="fp-wash-tl" />
        <div className="fp-wash-br" />
        ...
        <div className="relative z-10 flex flex-1 items-center justify-center px-4 py-10">
          <div className="fp-card">
            ...
            <div className="fp-header">
              ...
              {sent ? (
                <>
                  <h1 className="text-xl font-bold text-zinc-900 tracking-tight">Check your email</h1>
                ...
                <>
                  <h1 className="text-xl font-bold text-zinc-900 tracking-tight">Forgot password?</h1>
                  <p className="text-zinc-500 text-sm mt-1">
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="submit-btn" disabled={isLoading}>
                      {isLoading ? (
                        <><div className="btn-spinner" /> Sending reset link…</>
                      ) : (
                        <>Send reset link <ArrowRight className="w-4 h-4 arrow" /></>
                      )}
                    </button>
                  </form>
                </>
